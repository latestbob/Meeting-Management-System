...
<body>
  <div class="container-fluid">
    <div class="bg-dark text-center rounded">
        <h2 class="py-3 text-white font-weight-bold">PROGRAMME SCHEDULE</h2>
        ...
        <!--3 colum span-->
            <div class="col-lg-3 bg-success rounded px-0"id="short">
                <div id="myrow">
                    ...
                    <form action="member_schedule.php"method="POST">
            <div class="row">
            ...
            <div class="row">
                <button type="submit"name="schedule1" class="btn btn-light btn-block font-weight-bold mt-2 py-3 text-dark">SCHEDULES</button>
            </div><!--End of button sidebar div-->
                ...
                <div class="row">
                    <div class="col-lg-9 m-auto">
                        <div class="bg-success text-center rounded">
                            <h2 class="text-light py-3">6 MONTHS SCHEDULE</h2>
                            <div class="card">
