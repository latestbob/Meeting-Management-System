    ...
    <div class="row">
        <div class="col-lg-9 m-auto mt-4">
            <div class="bg-info text-center rounded">
                <h2 class="text-light font-weight-bold py-3">ADMIN LOGIN</h2>
            </div>
        </div>
    </div>
                    ...
                    <form action="process.php"method="POST">
                        ...
                        <div class="form-group m-3">
                            <div class="row">
                                ...
                                <button type="submit"name="admin_login"class="btn btn-success mt-4 py-1">ADMIN LOGIN</button>
                                </div>
                                
                                
                            </div>
                            <p class="text-center font-weight-bold py-2"><a href="member_login.php">Please Click to login as member</a></p>
